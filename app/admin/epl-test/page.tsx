    ...
    <div className="space-y-5">
      ...
      {fixtures && (
        <div className="border border-gray-300 rounded-xl overflow-hidden">
          ...
          {fixtures.map(f => (
            <button key={f.fixtureId} onClick={() => loadLineup(f.fixtureId)}
              className={`w-full text-left px-3 py-2.5 border-t border-gray-100 hover:bg-amber-50 ${selected===f.fixtureId?"bg-amber-50":""}`}>
